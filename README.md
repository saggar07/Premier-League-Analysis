...
Dataset Name: Premier League Player Statistics (https://www.kaggle.com/datasets/rishikeshkanabar/premier-league-player-statistics-updated-daily)

Source: Kaggle — Rishikesh Kanabar dataset

Data Type: Structured CSV with player-level statistics

Content: Each row represents a player with various performance and profile metrics including playing time, goals, assists, and position information. 
...
Player Participation – Total appearances and minutes played

Scoring Performance – Goals and assists comparisons

Positional Comparison – How forwards, midfielders, defenders, and goalkeepers differ

Top Performers – Leading players by key metrics

Disciplinary Trends – Fouls, yellow/red cards
...
Playmakers: Players leading in the metrics which make them a world class midfielders
